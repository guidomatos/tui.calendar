 ...
 * @property {Array.<string>} [daynames] - The day names in weekly and daily. Default values are ['Dom', 'Lun', 'Mar', 'Mie', 'Jue', 'Vie', 'Sab']
 ...
 * @property {Array.<string>} [daynames] - The day names in monthly. Default values are ['Dom', 'Lun', 'Mar', 'Mie', 'Jue', 'Vie', 'Sab']
 * @property {number} [startDayOfWeek=0] - The start day of week
 * @property {boolean} [narrowWeekend=false] - Make weekend column narrow(1/2 width)
